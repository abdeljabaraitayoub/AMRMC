                        ...
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    <a href="http://localhost"
                                        ...
                                        target="_blank"
                                        data-saferedirecturl="https://www.google.com/url?q=http://localhost&amp;source=gmail&amp;ust=1712158658323000&amp;usg=AOvVaw3CmUQ9Y2WAS4Yg8zZgoNxd">
                                        AMRMC
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <table class="m_-4267373283677338955inner-body" align="center" width="570"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        Great news, your Request to acces to our OpenData was
                                                        successfully Accepted by
                                                        AMRMC.</p>
                                                    @foreach ($links as $link)
                                                        {{-- @dd($link['model']) --}}
                                                        <p
                                                            style="box-sizing: border-box; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                            {{ $link['model'] }} : <a href="{{ $link['links']['csv'] }}"
                                                                style="text-decoration: none; ">csv</a>
                                                            <a href="{{ $link['links']['json'] }}"
                            ...
                            <tr>
                                <td
                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                    <table class="m_-4267373283677338955footer" align="center" width="570"
                                        cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <p
                                                        ...
                                                        © 2024 AMRMC. All rights reserved.</p>
