...
<template>
  ...
  >
    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      <div class="mt-4">
        <h3 class="mb-1.5 text-2xl font-medium text-black dark:text-white">{{ profile.name }}</h3>
        ...
        >
          <div
            class="flex flex-col items-center justify-center gap-1 border-r border-stroke dark:border-strokedark xsm:flex-row"
          >
            <span class="text-black dark:text-white">259</span>
          </div>
          <div
