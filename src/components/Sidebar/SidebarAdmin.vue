...
export default {
  ...
  methods: {
    closeSidebar() {
      this.sidebarStore.isSidebarOpen = false
    }
  },
  mounted() {
    this.target = this.$refs.sidebar
    onClickOutside(this.target, this.closeSidebar)
  },
  beforeMount() {
    if (this.role === 'admin') {
      this.menuGroups[0].menuItems = [
        {
          icon: `<svg
                  class="fill-current"
                  width="18"
        ...
        {
          icon: `<i class="bi bi-prescription2"></i>`,
          label: 'Medicament',
          route: '/medics'
      ...
      this.menuGroups[0].menuItems = [
        ...
        },
        {
          icon: `<i class="bi bi-activity"></i>`,
          label: 'Activities',
          route: '/association/activities'
          // children: [{ label: 'Settings', route: '/pages/settings' }]
        },
        {
          icon: `<i class="bi bi-gear"></i>`,
          label: 'Association Settings',
          route: '/association/settings'
        }
      ]
