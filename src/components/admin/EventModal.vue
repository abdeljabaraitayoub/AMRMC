...
<template>
  <div class="mt-6">
    <div
      ...
      style="z-index: 999"
    >
      <div class="my-auto mx-auto w-1/4">
        <!--content-->
        <div
          ...
          <form>
            ...
            <div class="my-5.5 flex flex-col gap-5.5 sm:flex-row">
              <div class="w-full">
                ...
                >
                <div class="relative">
                  <span class="absolute left-4.5 top-4"><i class="bi bi-calendar-check"></i> </span
                  ><input
                    v-model="modalStore.data.title"
            ...
            <div class="mb-5.5">
              <label class="mb-3 block text-sm font-medium text-black dark:text-white" for="Date"
                >End Date</label
              ><input
                v-model="modalStore.data.endDate"
