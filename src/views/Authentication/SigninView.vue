...
export default {
  ...
  //   onMounted(() => {
  //     authStore.setToken(
  //       'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vMC4wLjAuMC9hcGkvcmVnaXN0ZXIiLCJpYXQiOjE3MTA3OTYxNjIsImV4cCI6MTcxMDc5OTc2MiwibmJmIjoxNzEwNzk2MTYyLCJqdGkiOiJScmdYQkhGUm1YdGtqcWwwIiwic3ViIjoiMjIiLCJwcnYiOiIyM2JkNWM4OTQ5ZjYwMGFkYjM5ZTcwMWM0MDA4NzJkYjdhNTk3NmY3In0.MpJA3TUfI42sZG5afctZCpVySnBCvwrawprLrK6QgEM'
  //     )
  //   })
  //   return {}
  // }
...
<template>
  <DefaultLayout v-show="false">
    <!-- Breadcrumb Start -->
  </DefaultLayout>
  <!-- Breadcrumb End -->
  <div style="width: 75%; margin: auto; margin-top: 7%">
    <DefaultAuthCard subtitle="Start for free" title="Sign In to TailAdmin">
      <div>
        ...
        <div class="mt-6 text-center">
          <p class="font-medium">
            Don’t have any account? <a href="/signup" class="text-primary">Sign up</a>
          </p>
        </div>
      </div>
    </DefaultAuthCard>
